...
export const ADDR = ["อาคาร", "ห้องเลขที่", "ชั้นที่", "หมู่บ้าน", "เลขที่", "หมู่ที่", "ตรอก/ซอย", "แยก",
...
export const FORMS = {
  PND1:  { name: "ภ.ง.ด.1",  id: "person",   cols: [TIN, "คำนำหน้าชื่อ", "ชื่อ", "ชื่อสกุล", "วันเดือนปีที่จ่าย", "ประเภทเงินได้", "จำนวนเงินที่จ่าย", "จำนวนเงินภาษีที่หัก", "เงื่อนไข"] },
  PND2:  { name: "ภ.ง.ด.2",  id: "person",   cols: [TIN, "คำนำหน้าชื่อ", "ชื่อ", "ชื่อสกุล", ...ADDR, ...PAY], rates: ["10", "15"], unverified: true },
  PND3:  { name: "ภ.ง.ด.3",  id: "person",   cols: [TIN, "สาขาที่", "คำนำหน้าชื่อ", "ชื่อ", "ชื่อสกุล", ...ADDR, ...PAY], rates: ["1", "1.5", "2", "3", "5", "10", "15"] },
...
export const ALIASES = {
  ...
  "เลขที่เอกสาร": "เลขที่เอกสารอ้างอิง", "ตำบล": "ตำบล/แขวง", "อำเภอ": "อำเภอ/เขต", "ซอย": "ตรอก/ซอย",
};
